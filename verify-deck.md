# Deck Verification Swarm

> **What this is:** A prompt for Claude Code. When verifying a presentation, read this file and follow the instructions. Claude Code will launch 6 parallel sub-agents, each opening the HTML in its own Playwright browser session, analyzing from a unique POV, and reporting findings with severity levels. Issues can then be fixed automatically.
...
- The absolute path to the HTML file being verified
