...
const ACTION_CATALOG = Object.freeze([
  ...
  },
  {
    ...
    label: 'Export files',
    surface: ACTION_SURFACES.DIALOG,
    kind: ACTION_KINDS.PRESENTATION,
  },
  {
...
async function resolveActionAvailability(action, {
  ...
  if (action.kind === ACTION_KINDS.PRESENTATION) {
    if (!meta?.active) {
...
const ACTION_WORKFLOW_METADATA = Object.freeze({
  ...
  export_presentation_artifacts: {
    workflowId: 'presentation-export-artifacts',
    allowedTriggers: DEFAULT_ALLOWED_TRIGGERS,
    sideEffectPolicy: 'writes-direct-export-artifacts',
    lifecycleEventPolicy: 'standard-action-lifecycle',
  },
