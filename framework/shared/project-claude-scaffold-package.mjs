...
function buildRequiredPaths(entries) {
...
export function getProjectClaudeScaffoldPackage(options = {}) {
  ...
  return {
    ...
    entries,
    requiredPaths: buildRequiredPaths(entries),
  };
}

export function writeProjectClaudeScaffoldPackage(projectRootAbs, options = {}) {
  const scaffoldPackage = getProjectClaudeScaffoldPackage(options);
  const createdPaths = [];
