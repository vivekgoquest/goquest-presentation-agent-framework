...
Use this when starting a brand-new presentation workspace.
...
- preview /preview/ in the browser so agents can verify the story and use the Export PDF button for quick downloads
