---
name: operator-console-judge
description: Judge the output of an autonomous operator-console run from the user-visible artifacts only. Use when a separate agent should review the final result rather than build it.
user-invocable: true
---
