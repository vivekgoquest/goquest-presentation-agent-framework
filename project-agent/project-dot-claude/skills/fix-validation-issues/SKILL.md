...
description: Fix deterministic validation failures in a presentation project. Use when audit or finalize reports validation failures that need resolving.
user-invocable: true
---
...
3. whether the audit now passes clean
